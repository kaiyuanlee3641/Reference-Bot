...
export declare type APIActionRowComponentTypes = APIMessageComponent | APIModalComponent;
/**
 * https://discord.com/developers/docs/interactions/message-components#message-components
 */
export declare type APIMessageComponent = APIActionRowComponent<APIMessageComponent> | APIButtonComponent | APISelectMenuComponent;
export declare type APIMessageActionRowComponent = APIActionRowComponent<APIMessageComponent>;
export declare type APIModalComponent = APIActionRowComponent<APIModalComponent> | APITextInputComponent;
export declare type APIModalActionRowComponent = APIActionRowComponent<APIModalComponent>;
export {};
